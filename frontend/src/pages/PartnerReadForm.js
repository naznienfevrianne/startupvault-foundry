...
const PartnerDetails = () => {
    ...
    return (
        <section className="flex flex-col px-5 pt-9 pb-20 max-md:max-w-full">
            <a href="/partnerEditForm" className="flex flex-wrap gap-5 justify-between content-center pr-20 max-md:pr-5">
                <h1 className="text-3xl font-semibold tracking-wider leading-[54px] text-stone-100 max-md:text-3xl">Partner Details</h1>
