        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
          ...
          <div className="flex flex-col ml-5 w-[43%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow max-md:mt-8 max-md:max-w-full">
              <div className="text-4xl font-semibold tracking-wider leading-[70.8px] text-stone-100 max-md:max-w-full max-md:text:4xl">
                SIGN UP
              </div>
              <div className="mt-2 text-base font-medium tracking-wide text-stone-100 max-md:max-w-full">
                Email Address
              </div>
              <input 
                type="email" 
              ...
              <div 
              className="justify-center self-center px-5 py-2 mt-3 text-base font-semibold text-black bg-green-400 rounded-3xl shadow-sm max-md:mt-10 hover:bg-green-500 cursor-pointer"
