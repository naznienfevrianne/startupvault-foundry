          ...
          <div className="self-center mt-10 max-w-full w-[725px] max-md:mt-10">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              ...
              className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow justify-end self-stretch px-5 pt-5 pb-9 w-full text-center rounded-lg border border-black border-solid bg-neutral-800 max-md:px-5 max-md:mt-10 hover:border-green-400 border-solid cursor-pointer">
                  <img
                    loading="lazy"
              ...
              className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow justify-end self-stretch px-5 py-5 pb-9 w-full text-center rounded-lg border border-black border-solid bg-neutral-800 max-md:px-5 max-md:mt-10 hover:border-green-400 border-solid cursor-pointer">
                  <img
                    loading="lazy"
