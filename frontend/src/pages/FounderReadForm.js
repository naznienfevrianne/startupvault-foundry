    ...
    return (
        <section className="flex flex-col px-5 pt-9 pb-20 max-md:max-w-full">
            ...
            {profilePicture ? (
              ...
              <div className="flex flex-1 justify-center items-center">
                <img loading="lazy" 
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/301d1c1baa7c888ca094c200e6628c0467efd8a91277c3e53073791219eac3ab?apiKey=9ff2a73e8144478896bce8206c80f3e2&" 
