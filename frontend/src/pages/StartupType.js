          ...
          <div className="mt-4 max-md:mt-10 max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
              ...
              onClick={() => handleStartupType(1)}>
                <div className="flex flex-col grow justify-end self-stretch px-5 py-5 w-full text-center rounded-lg border-[3px] border-white bg-neutral-800 max-md:px-5 max-md:mt-10 hover:border-green-400 border-solid cursor-pointer">
                  <img
                    loading="lazy"
