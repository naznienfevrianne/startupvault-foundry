...
function InvestorDetails(props) {
  ...
  const idInvestor = myCookies.get('investor')
  ...
  const fetchDataInvestor = async () => {
    try {
        ...
        const response = await fetch(`http://localhost:8000/auth/investor/43/`, {
            method: "GET", 
            headers:{
          ...
          <div className="flex flex-col ml-5 w-[77%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow px-5 pt-9 pb-20 max-md:mt-5 max-md:max-w-full">
              <div className="flex flex-wrap gap-0 content-center pr-20 max-md:pr-5">
                ...
                <div className="flex gap-1.5 ml-2 justify-between px-0.5 my-auto text-base tracking-wide text-neutral-400">
              ...
              />
              <div className="mt-5 text-base font-medium tracking-wide text-stone-100 max-md:max-w-full">
                Name
              </div>
