        ...
        <div className="flex flex-col grow items-end pt-6 pr-5 pl-20 max-md:pl-5 max-md:max-w-full">
          ...
          <div className="flex flex-col p-6 mt-6 max-w-full rounded-lg bg-neutral-800 w-[822px] max-md:px-5">
                ...
                <div className="flex flex-col whitespace-nowrap">
                  ...
                  <div className="flex gap-2 mt-2 text-lg">
                    ...
                    <div className="flex gap-1 px-2 py-1.5 font-light tracking-wide text-white rounded-3xl">
                      ...
                      />
                      <div className="underline">Jakarta</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-5 justify-center mt-6 max-md:flex-wrap">
              <div className="flex flex-col flex-1 rounded-md bg-neutral-800">
                ...
                <div className="mt-2 text-lg tracking-wide text-ellipsis text-neutral-400">
                  Education Technology, Financial Tech
                </div>
              </div>
              <div className="flex flex-col flex-1 rounded-md bg-neutral-800">
                <div className="flex gap-3 py-1">
            ...
            <div className="mt-6 text-lg tracking-normal text-stone-100 max-md:max-w-full">
              Edugrow is a platform and the next generation platform designed for
              modern education. Our intuitive interface brings interactive lessons,
              real-time collaboration, and personalized learning paths directly to
              your screen.
            </div>
